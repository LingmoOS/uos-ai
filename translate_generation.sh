...
${lupdate} -extensions cpp,cxx,cc,h,hpp src/ -ts -no-obsolete translations/uos-ai-assistant_zh_CN.ts
${lupdate} -extensions cpp,cxx,cc,h,hpp plugin-tray/ -ts -no-obsolete translations/uos-ai-tray_zh_CN.ts
${lupdate} -extensions cpp,cxx,cc,h,hpp plugin-settings/ -ts -no-obsolete translations/uos-ai-settings_zh_CN.ts
