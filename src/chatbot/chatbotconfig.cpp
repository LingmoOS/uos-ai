...
QString ChannelConfig::baseUrl()      const { return m_raw.value("base_url").toString(); }
QString ChannelConfig::botToken()     const { return m_raw.value("bot_token").toString(); }
QString ChannelConfig::cdnBaseUrl()   const { return m_raw.value("cdn_base_url").toString(); }
QString ChannelConfig::accountId()    const { return m_raw.value("account_id").toString(); }
QString ChannelConfig::userId()       const { return m_raw.value("user_id").toString(); }
